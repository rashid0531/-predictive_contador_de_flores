...
class CanolaTimelapseImage(CanolaObject):
    ...
    def showDetectedBlobs(self):
        ...
        cv2.imshow("{} {}".formaregionManagert(self.__plot, self.__timestamp), img)
        cv2.waitKey(0)
...
def findImagesLocally(imagesBasePath):
    ...
    # regionObject.setCorners([(0, 0), (227, 0), (0, 227), (227, 227)])
    regionObject.setCorners([(0, 227), (227, 227), (0, 227), (227, 227)])
