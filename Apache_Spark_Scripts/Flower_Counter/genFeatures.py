...
def main(argv):
    ...
    print
    "Loading configuration file: ", cfg_file
    ...
    "Dataset: ", dataset
    print
    "Data base location: ", im_folder
    print
    "Image names file: ", im_list_file
    print
    "Output file:", output_file
    print
    "Output feature names file:", feature_file_path
    print
    "Dot image ending: ", dot_ending
    print
    "Patch width (pw_base): ", pw_base
    print
    "Patch width (pw_norm): ", pw_norm
    print
    "Patch width (pw_dens): ", pw_dens
    print
    "Number of patches per image: ", Nr
    print
    "Perspective map: ", perspective_path
    print
    "Use perspective:", use_perspective
    print
    "Sigma for each dot: ", sigmadots
    print
    ...
    for ix, name in enumerate(im_names):
        ...
        if split_size > 0 and (ix + 1) % split_size == 0:
            ...
            print
            "Saving data file: ", opt_num_name
            print
            "Saving {} examples".format(len(ldens))
